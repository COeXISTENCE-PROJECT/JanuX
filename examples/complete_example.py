...
from path_generators import basic_route_generator
...
if __name__ == "__main__":
    ...
    routes = basic_route_generator(network, origins, destinations, num_samples=100, number_of_paths=3)
    ...
    routes.to_csv("examples/results/routes.csv", index=False)